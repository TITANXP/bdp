...
insert into bdp_master.metric_threshold (metric_name, amber_threshold, red_threshold, server_id, creation_time, update_time) values ('cpu.usage', 80, 90, 1, '2018-09-01 00:00:00', '2018-09-01 00:00:00');
insert into bdp_master.metric_threshold (metric_name, amber_threshold, red_threshold, server_id, creation_time, update_time) values ('mem.used', 5120, 5760, 1, '2018-09-01 00:00:00', '2018-09-01 00:00:00');
insert into bdp_master.metric_threshold (metric_name, amber_threshold, red_threshold, server_id, creation_time, update_time) values ('cpu.usage', 80, 90, 2, '2018-09-01 00:00:00', '2018-09-01 00:00:00');
insert into bdp_master.metric_threshold (metric_name, amber_threshold, red_threshold, server_id, creation_time, update_time) values ('mem.used', 5120, 5760, 2, '2018-09-01 00:00:00', '2018-09-01 00:00:00');
